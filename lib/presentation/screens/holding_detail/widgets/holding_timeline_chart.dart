...
/// The three insight tabs available in the chart section.
enum ChartTab { investment, qtyPrice, cashFlow }
...
class _HoldingTimelineChartState extends State<HoldingTimelineChart> {
  ...
  void _onPanZoom(ScaleUpdateDetails details, int dataLen) {
    if (details.scale != 1.0) {
      setState(() {
        ...
        _minX = (mid - newRange / 2).clamp(0, dataLen - 1 - newRange);
      ...
      setState(() {
        ...
        _minX = (_minX + delta).clamp(0, dataLen - 1 - range);
        _maxX = _minX + range;
      });
    }
  }
  ...
  // ─── Chart 1: Investment (Cost Basis) Area Chart ───────────────────────
  ...
  // ─── Chart 2: Quantity & Price Dual-Line Chart ─────────────────────────
  ...
  // ─── Chart 3: Net Cash Flow Bar Chart ──────────────────────────────────
  ...
  // ── Touch callback for line charts ─────────────────────────────────────
