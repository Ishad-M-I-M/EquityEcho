...
class _HoldingDetailScreenState extends State<HoldingDetailScreen> {
        ...
        actions: [
          if (widget.symbol.contains('.R'))
            IconButton(
              ...
              onPressed: () => _showConvertRightsDialog(context),
  ...
  void _showConvertRightsDialog(BuildContext context) {
    if (!widget.symbol.contains('.R')) return;
    final defaultTargetSymbol = widget.symbol.split('.').first + '.N0000';
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Icon(Icons.autorenew, color: Colors.deepPurpleAccent, size: 20),
                                const SizedBox(width: 8),
                                const Text(
                                  'Convert Rights',
                                  style: TextStyle(
                            ...
                            const SizedBox(height: 6),
                            Text(
                              'Convert your ${widget.symbol} rights into regular shares.',
                              style: TextStyle(
                                color: AppTheme.textSecondary,
                                fontSize: 13,
                              ),
