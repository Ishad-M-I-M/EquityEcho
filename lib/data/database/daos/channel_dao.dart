...
class ChannelDao extends DatabaseAccessor<AppDatabase> with _$ChannelDaoMixin {
  ...
  Future<Channel?> getChannelBySender(String senderAddress) => (select(
    channels,
  )..where((c) => c.senderAddress.equals(senderAddress))).getSingleOrNull();
